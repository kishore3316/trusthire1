    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-hero-gradient items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <h1 className="text-5xl font-bold font-display text-primary-foreground mb-4 animate-fade-in">
          ...
          <div className="mt-8 rounded-xl overflow-hidden border border-primary-foreground/10 shadow-2xl group cursor-pointer">
            <div className="relative overflow-hidden">
              <img src={studentsImg} alt="Students collaborating" className="w-full h-48 object-cover transition-transform duration-700 group-hover:scale-110" />
